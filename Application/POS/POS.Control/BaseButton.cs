...
namespace POS.Control
{
    public partial class BaseButton : Button
    {
        ...
        private POS.Control.Theme thm = POS.Control.Theme.MSOffice2010_WHITE;
        ...
        public BaseButton()
        {
            ...
            this.Theme = Control.Theme.MSOffice2010_WHITE;
        ...
        public POS.Control.Theme Theme
        {
            get
            {
                if (this.colorTable == Colortable.Office2010Green)
                {
                    return POS.Control.Theme.MSOffice2010_Green;
                }
                else if (this.colorTable == Colortable.Office2010Red)
                {
                    return POS.Control.Theme.MSOffice2010_RED;
                }
                else if (this.colorTable == Colortable.Office2010Pink)
                {
                    return POS.Control.Theme.MSOffice2010_Pink;
                }
                else if (this.colorTable == Colortable.Office2010Yellow)
                {
                    return POS.Control.Theme.MSOffice2010_Yellow;
                }
            ...
            set
            {
                ...
                if (thm == POS.Control.Theme.MSOffice2010_Green)
                {
                    this.colorTable = Colortable.Office2010Green;
                }
                else if (thm == POS.Control.Theme.MSOffice2010_RED)
                {
                    this.colorTable = Colortable.Office2010Red;
                }
                else if (thm == POS.Control.Theme.MSOffice2010_Pink)
                {
                    this.colorTable = Colortable.Office2010Pink;
                }
                else if (thm == POS.Control.Theme.MSOffice2010_WHITE)
                {
                    this.colorTable = Colortable.Office2010White;
                }
                else if (thm == POS.Control.Theme.MSOffice2010_Yellow)
                {
