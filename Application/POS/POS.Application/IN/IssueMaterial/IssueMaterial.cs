...
{
    public partial class IssueMaterial : BaseAddEditMaster
    {
        #region :: Constructure ::
        ...
        public IssueMaterial(string Code)
        {
        ...
        private void LoadDetailData(int index)
        {
            ...
            ddlLotno.Text = dr["lot_no"].ToStringNullable();
        ...
        private TranDetail GetDetailData()
        {
            ...
            entity.lot_no = Converts.ParseLong(ddlLotno.Text);
        ...
        private void ValidationDetail(TranDetail entity)
        {
            ...
            if (string.IsNullOrEmpty(ddlLotno.Text))
            {
            ...
            else if (Converts.ParseLongNullable(ddlLotno.Text) == null)
            {
        ...
        {
            ddlLotno.Text = this.GetLastLotNo().ToString();
        }
