...
{
    public partial class ucCountStock : BaseUserControl
    {
        ...
        {
            addEditcountStock = new AddEditCountStock();
            this.AddEditTab(string.Format(TabName.Add, programName), addEditcountStock);
        }
        public void grdBase_onSelectedDataRow(object sender, Control.GridView.RowEventArgs e)
        {
            ...
            addEditcountStock = new AddEditCountStock(dataKey[DataKeyName].ToString());
            this.AddEditTab(string.Format(TabName.Edit, programName), addEditcountStock);
        }
        ...
        private void AddEditTab(string TabTitle, AddEditCountStock controlAddEdit)
        {
