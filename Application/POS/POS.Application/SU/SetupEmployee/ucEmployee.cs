...
namespace POS.SU.SetupEmployee
{
    public partial class ucEmployee : BaseUserControl
    {
        ...
        public void grdBase_onAddNewRow(object sender, EventArgs e)
        {
            ...
            this.AddEditTab(string.Format(TabName.Add, programName), addEditEmployee);
        }
        public void grdBase_onSelectedDataRow(object sender, Control.GridView.RowEventArgs e)
        {
            ...
            addEditEmployee = new AddEditEmployee(dataKey[DataKeyName].ToString());
            this.AddEditTab(string.Format(TabName.Edit, programName), addEditEmployee);
        }
        public void grdBase_onDeleteDataRows(object sender, Control.GridView.RowsEventArgs e)
        {
            try
            {
                ...
                ServiceProvider.EmployeeService.Delete(listEmp);
            }
        ...
        private void AddEditTab(string TabTitle, AddEditEmployee controlAddEdit)
        {
