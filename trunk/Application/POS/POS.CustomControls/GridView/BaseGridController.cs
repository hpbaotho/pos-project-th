...
namespace POS.CustomControls.GridView
{
    class BaseGridController:IDataGrid
    {
        ...
        public void AddDataToGrid(EntityBase entity)
        {
            
        }
        public void UpdateGridWithChangedUser(EntityBase entity)
        {
            
        }
        public void RemoveFromGrid(EntityBase entity)
        {
            
        }
        public string GetIdOfSelectedGrid()
        {
            string result = "";
            return result;
        }
        public void SetSelectedGrid(EntityBase entity)
        {
