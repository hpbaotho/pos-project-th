...
namespace POS.IN.SendMaterial
{
    public partial class ucSendMaterial : BaseUserControl
   {
        ...
        {
            addEditSendMaterial = new AddEditSendMaterial();
            this.AddEditTab(string.Format(TabName.Add, programName), addEditSendMaterial);
        }
        public void grdBase_onSelectedDataRow(object sender, Control.GridView.RowEventArgs e)
        {
            ...
            addEditSendMaterial = new AddEditSendMaterial(dataKey[DataKeyName].ToString());
            this.AddEditTab(string.Format(TabName.Edit, programName), addEditSendMaterial);
        }
        ...
        private void AddEditTab(string TabTitle, AddEditSendMaterial controlAddEdit)
        {
