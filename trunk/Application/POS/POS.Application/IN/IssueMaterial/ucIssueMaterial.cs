...
namespace POS.IN.IssueMaterial
{
    public partial class ucIssueMaterial : BaseUserControl
    {
        ...
        IssueMaterial issueMaterial = new IssueMaterial();
        string programName = ProgramName.SetupINIssueMaterial;
        string tabName = "List Issue Material";
        ...
        {
            issueMaterial = new IssueMaterial();
            this.AddEditTab(string.Format(TabName.Add, programName), issueMaterial);
        }
        public void grdBase_onSelectedDataRow(object sender, Control.GridView.RowEventArgs e)
        {
            ...
            issueMaterial = new IssueMaterial(dataKey[DataKeyName].ToString());
            this.AddEditTab(string.Format(TabName.Edit, programName), issueMaterial);
        }
        ...
        private void AddEditTab(string TabTitle, IssueMaterial controlAddEdit)
        {
